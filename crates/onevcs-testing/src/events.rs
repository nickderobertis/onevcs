...
//! exposes no writer; the envelope, its source word and its phases are `onevcs`'s
//! own, named through it rather than copied.
...
use onevcs::{
    ArtifactId, Dimensions, Envelope, Error, EventKind, Labels, Phase, PhaseOf, Result, Source,
    SOURCE_WORD,
};
